...
from core.views import home, about, confirm, confirm_password, contact_us, inter_confirm
from .views import StaticHTMLView
...
urlpatterns = [
    ...
    path('html/<str:page_name>/', StaticHTMLView.as_view(), name='html_page'),
]
